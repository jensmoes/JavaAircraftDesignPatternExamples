...
public class HamiltonPath {
	...
	static final int MAX_TIME =24*60*60*1000;//ms to recurse in search for candidates. 250 is pretty good(About 30 mins). 2 min is decent for vetting candidates
...
//			printTimeStamp();
			...
			System.out.printf("Starting node %d,  %d (%d left)\n",nd.i,nd.j,nodes.size());
			int div = total/100;
